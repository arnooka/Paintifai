/*var config = function (require) {
    //Notice the space between require and the arguments.
    config = require('./lib/config');
};
var token = function (require) {
    //Notice the space between require and the arguments.
    token = require('./lib/token');
};
var tag = function (require) {
    //Notice the space between require and the arguments.
    tag = require('./lib/tag');
};
var info = function (require) {
    //Notice the space between require and the arguments.
    info = require('./lib/info');
};
var languages = function (require) {
    //Notice the space between require and the arguments.
...
var color = function (require) {
    //Notice the space between require and the arguments.
    color = require('./lib/color');
};
var feedback = function (require) {
    //Notice the space between require and the arguments.
    feedback = require('./lib/feedback');
};
var usage = function (require) {
    //Notice the space between require and the arguments.
